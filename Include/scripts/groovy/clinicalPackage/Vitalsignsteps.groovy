...
class Vitalsignsteps {
	...
	public void successfully_alertpopup_for_vitalsign() {
		...
		WebUI.verifyElementText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_Alergies/Obj_Alertsaved'),
				findTestData('DF_CMRData/DF_ClinicalSection/TD_VitalSigns').getValue(13, 1))
	...
	@And("I should see the newly added vital signs on grid")
	public void added_data_visibleon_UI_for_vitalsign() {
		def now = new Date().format('MM/dd/yyyy')

		def	temp = (now + ' 01:30:00 AM')
		...
		WebUI.verifyElementText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_VitalSigns/Obj_td_BMI'), findTestData(
				'DF_CMRData/DF_ClinicalSection/TD_VitalSigns').getValue(21, 1))

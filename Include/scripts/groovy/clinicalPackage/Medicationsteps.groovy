...
class Medicationsteps {
	...
	def I_enter_name_of_medication(String Name){
		...
		Thread.sleep(1000)
		WebUI.sendKeys(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_Medication/Obj_cmtake_code'), Keys.chord(Keys.ENTER))
	}
	...
	def I_set_prescribed_by_from_dropdown(String Presribedby){
		...
		String xpath4 = ('(//li[text()="' + Presribedby) + '"])'
	...
	def very_data_of_medication_should_be_visible_on_the_UI(){

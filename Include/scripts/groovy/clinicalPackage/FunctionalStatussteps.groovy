...
class FunctionalStatussteps {
	...
	public void successmessage_added_functionalstatus() {
		...
		WebUI.verifyElementText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_Alergies/Obj_Alertsaved'),  findTestData(
				'DF_CMRData/DF_ClinicalSection/FunctionalStatus').getValue(3, 1))
	...
	@And("I should see the newly added functional status on grid")
	public void newlyadded_functionalstatus_on_grid() {

		'Verify the Entered Data'
		WebUI.verifyElementText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_Funtionalstatus/Obj_td_condition'),  findTestData(
				'DF_CMRData/DF_ClinicalSection/FunctionalStatus').getValue(4, 1))

		WebUI.verifyElementText(findTestObject('OR_PatientGrid/OR_PatientData/OR_Clinical Section/OR_Funtionalstatus/Obj_td_startdate'), findTestData(
				'DF_CMRData/DF_ClinicalSection/FunctionalStatus').getValue(5, 1))
	}

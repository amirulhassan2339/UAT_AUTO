...
class AddEncountersteps {
	...
	def deleteencounter(String Encounter) {
		...
		String xpathd2 = "(//span[@class='input-source persivia']//parent::td//parent::tr)[" +i +"]//td[19]//button[@class='k-button k-button-icontext k-grid-delete']"

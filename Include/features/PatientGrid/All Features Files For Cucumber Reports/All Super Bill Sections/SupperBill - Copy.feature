Feature: Supper Bill flows
  ...
  Scenario Outline: Verify that patients are filtered against the selected soap status signed
    ...
    * I click on Apply button to apply supper bill filters
    ...
    Examples: 
      | Patient   | Reason    | ThePatientUnderstands                                                             | LocationOfVisit | PCName | PC_PhoneNumber | PatientCareTeam_Notes                                                             | Temp | Pulse | Repeat_Pulse | Resp_Rate | Pulse_Ox | Repeat_Pulse_Ox | Constitutional       | Soap_Status |
      | ADam, Tom | Back pain | I am not assuming any responsibility for their care of providing direct treatment | Office          | Amir   |   032545235210 | I am not assuming any responsibility for their care of providing direct treatment |  102 |    50 |           60 |        20 |      100 |              85 | In no acute distress | Signed      |

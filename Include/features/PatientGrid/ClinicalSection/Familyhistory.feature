...
#		And I should see the newly added family history on grid
		...
		|Robit, Robit|   ICD-9   |THER ULT HEAD & NECK VES::00.01|Foster child| Male | 01012021 |01122021|   Yes  |  Yes   |No disease found in family|
...
#		And I should see the newly added family history on grid
		...
		Examples:
		|   Patient    |Source_Code|             Code_Name             | Relationship  |Gender|Start_Date|End_Date|Negation|Deceased|         Comments         |
		|Robit, Robit|    HPC    |Outside state ambulance serv::A0021|Foster daughter|Female| 03112021 |03182021|   No   |  Yes   |Edit family history record|

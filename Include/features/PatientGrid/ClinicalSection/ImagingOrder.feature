...
#		And I should see the newly added imaging order on grid
    ...
    |Robit, Robit|Radiology Center New Jersey|Latif, Zohaib |02012021 21:38| Patient |       HPC       |Outside state ambulance serv::A0021|02012021 21:38|(Cholera due to Vibrio cholerae 01, biovar cholerae)|Abnormal hematopoietic cell (cell)|Imaging Order|
...
#		And I should see the newly added imaging order on grid
    ...
    Examples:
    |    Patient   |      Imaging_Center     |Order_Provider|      Date    |Bill_Type|Imaging_Test_Type|        Imaging_Test           |Effective_Date|      Diagnoses       |                  Body_Site              |      Comments    |
    |Robit, Robit|Fairfax Radiology Centers|Latif, Zohaib |02012021 21:38| Patient |      LOINC      |Amdinocillin Islt KB::1-Sep    |02012021 21:38|(Cholera, unspecified)|Bone structure of tarsus (body structure)|Edit Imaging Order|
  ...
  Given I search <Patient> using global search
    ...
    |Robit, Robit|Fairfax Radiology Centers|
    #

...
#		And I should see the newly added lab order on grid
	
    Examples:    
   |    Patient    |    Laboratary   |      Date      |   Panel   |STAT|Diagnosis|Collection_Date |Type |Specimen_No|      Notes    |
   |Robit, Robit |Quest Diagnostics|01/28/2021 13:57|Lipid Panel|Yes |  A00.0  |01/28/2021 13:57|Serum|     10    |Lab order added|
...
#		And I should see the newly added lab order on grid
    ...
    Examples:    
   |    Patient    |         Laboratary      |      Date      |      Panel      |STAT|Diagnosis|Collection_Date | Type |Specimen_No|      Notes    |
   |Robit, Robit|Whitehouse Analytical Lab|01/28/2021 13:57|Electrolyte Panel|Yes |  A00.9  |01/28/2021 13:57|Plasma|     10    |Lab order edit |
  ...
  Given I search <Patient> using global search
    ...
    Examples:    
   |    Patient    |         Laboratary      | 
   |Robit, Robit |Whitehouse Analytical Lab|
   #
   #

...
#		And I should see the newly added social history on grid
   ...
   |Robit, Robit|Tobacco use and exposure|under observation| 01012021 |01122021|
...
#		And I should see the newly added social history on grid
   ...
   Examples:
   |   Patient    |    Type      |     Observation    |Start_Date|End_Date|
   |Robit, Robit|Smoking status|Edit the observation| 03082021 |03172021|

...
#		And I should see the newly added medication on grid
		

 Examples:
     |    Patient   |Source_Type|                               Name                              |  Frequency  |      Route     |Start_Date|Prescribed_By|CPOE|eSent|Drug_Formulacy|        Directions         |
     |Robit, Robit|    MMSL   |Humulin R U-500 KwikPen 500unit/ml Solution for Injection::100034|3 times a day|Auricular (otic)| 12102020 |Mason, Elijah| Yes| Yes |     Yes      |As per the doctor recommend|
...
#		And I should see the newly added medication on grid
 ...
 Examples:
     |    Patient   |Source_Type|              Name                 |  Frequency  |Route |Start_Date|Prescribed_By|CPOE|eSent|Drug_Formulacy|              Directions             |
     |Robit, Robit|    HPC    |Advanced life support mileag::A0390|Every 8 hours|Dental| 03172021 |Oliver, Jacob| Yes|  No |      No      |Edit directions in case of medication|

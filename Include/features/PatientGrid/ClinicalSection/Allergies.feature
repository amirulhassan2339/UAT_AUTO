...
#		And I should see the newly added allergies on grid
		
    Examples:
    |   Patient    |       Type         |Source|               Allergy           |                   Reaction                  |Severity|Status|Start_Date|End_Date|        Comments         |
    |Robit, Robit|Allergy to substance|SNOMED|Allergy to insect venom (finding)|Edema of lower extremity (finding)::102572006|Moderate|Active| 01042021 |01232021|For a long time suffering|
...
#		And I should see the newly added allergies on grid
    ...
    Examples:
    |   Patient    |    Type    |Source|      Allergy        |        Reaction        |Severity|Status|Start_Date|End_Date|         Comments         |
    |Robit, Robit|Food allergy|Custom|Allergy Set by custom|Apnea (finding)::1023001| Severe |Active| 03142021 |03172021|suffering due to allergies|
  ...
  Given I search <Patient> using global search
    ...
    Examples:
    |   Patient    |    Type    |      
    |Robit, Robit|Allergy to substance|

...
#		And I should see the newly added functional status on grid
		...
		|Robit, Robit|Spirometry reversibility negative (finding):: 314980001|01012021|
...
#		And I should see the newly added functional status on grid
		...
		Examples:
		|    Patient   |                           Condition                           |  Date  |
		|Robit, Robit|Negative reversibility test to salbutamol (finding):: 391111000|03132021|
    ...
    *   I enter <Condition> to delete record in functional status 
	 Then I should see success message for deleted record
	  And I should see the deleted functional status not present on grid
		...
		Examples:
		|    Patient   |                           Condition                           | 
		|Robit, Robit|Negative reversibility test to salbutamol (finding):: 391111000|
#		
...
#	  And I should see the newly added problem on grid
		
 
 Examples:
    |    Patient   |                     Code_Name                            | Start_Date | Severity |   Type  | Status|   Rank   |
    |Robit, Robit| Cholera due to Vibrio cholerae 01, biovar cholerae::A00.0| 01072021   | Moderate |Condition| Active| Principal|
...
#	  And I should see the newly added problem on grid
 ...
 Examples:
    |    Patient   |        Code_Name          | Start_Date |Severity|   Type  | Status|   Rank   |
    |Robit, Robit|Cholera, unspecified::A00.9| 03082021   | Severe |Diagnosis| Active| Secondary|
...
Scenario Outline: Delete the specific record in problem List
 ...
 Examples:
    ...
    |Robit, Robit|Cholera due to Vibrio cholerae 01, biovar cholerae::A00.0|
    #
    #

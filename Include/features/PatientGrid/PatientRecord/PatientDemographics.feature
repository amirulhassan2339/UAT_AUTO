...
#		And I should see the newly created patient on grid
    ...
    |Robeb|   aqib   |   amib      |  Khaki  | Mr  |  Willian |Female|12032020|     Female    |Straight or Heterosexual|   Lahore   | Punjab   |  Pakistan  |    Married   |English |Asian|  Pakistani  |Hispanic or Latino|    Asturian      | Islam  |  MHPN  | Thiokar niaz | north punjab|   Punjab    |    0123   |  Near Iran    |0139848973|0174888888|013344333333|       Home    |test@ss.com|add new patient|   
...
Examples:
  ...
  Given I search <Patient> using global search
   ...
   @EmailResend
   @Sanity
    Scenario: Email resend when email in demographics record of patient
   When I click on patient account button to send email 
